...
# Unlock test page 
I2C_REG_WRITE( device_address="0x68", register_address=0x2F, write_value=0xAA,PageNo=1)
I2C_REG_WRITE( device_address="0x68", register_address=0x2F, write_value=0xBB,PageNo=1)
# Switch to page 0
