...
def startup():
  ...
  I2C_WRITE(device_address="0x38",field_info={'fieldname': 'iopad0_hyst', 'length': 1, 'registers': [{'REG': '0x38', 'POS': 0, 'RegisterName': 'IOPAD0 pad config', 'RegisterLength': 8, 'Name': 'iopad0_hyst', 'Mask': '0x1', 'Length': 1, 'FieldMSB': 0, 'FieldLSB': 0, 'Attribute': 'NNNN000N', 'Default': '0x01', 'User': '00YYYYYY', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG0'}]},write_value=0x1)
  I2C_WRITE(device_address="0x38",field_info={'fieldname': 'iodata1_hyst', 'length': 1, 'registers': [{'REG': '0x39', 'POS': 3, 'RegisterName': 'IODATA1 pad config', 'RegisterLength': 8, 'Name': 'iodata1_hyst', 'Mask': '0x8', 'Length': 1, 'FieldMSB': 3, 'FieldLSB': 3, 'Attribute': 'NN00N0NN', 'Default': '0x08', 'User': '00YYYYYY', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG0'}]},write_value=0x1)
  I2C_WRITE(device_address="0x38",field_info={'fieldname': 'ioclk1_hyst', 'length': 1, 'registers': [{'REG': '0x3A', 'POS': 3, 'RegisterName': 'IOCLK1 pad config', 'RegisterLength': 8, 'Name': 'ioclk1_hyst', 'Mask': '0x8', 'Length': 1, 'FieldMSB': 3, 'FieldLSB': 3, 'Attribute': 'NNNNN0NN', 'Default': '0x08', 'User': '00YYYYYY', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG0'}]},write_value=0x1)
  I2C_WRITE(device_address="0x38",field_info={'fieldname': 'ioclk2_hyst', 'length': 1, 'registers': [{'REG': '0x3C', 'POS': 3, 'RegisterName': 'IOCLK2 pad config', 'RegisterLength': 8, 'Name': 'ioclk2_hyst', 'Mask': '0x8', 'Length': 1, 'FieldMSB': 3, 'FieldLSB': 3, 'Attribute': 'NNNNN0NN', 'Default': '0x08', 'User': '00YYYYYY', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG0'}]},write_value=0x1)
  ...
  page_val = I2C_READ(device_address="0x38",field_info={'fieldname': 'i2c_page_sel', 'length': 1, 'registers': [{'REG': '0xFE', 'POS': 0, 'RegisterName': 'Page selection', 'RegisterLength': 8, 'Name': 'i2c_page_sel', 'Mask': '0x1', 'Length': 1, 'FieldMSB': 0, 'FieldLSB': 0, 'Attribute': '0000000N', 'Default': '0x00', 'User': '000000YY', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG0'}]},expected_value=0x1)
  print(f'page_value {page_val}')
