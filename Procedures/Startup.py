...
def startup():
  ...
  I2C_WRITE(device_address="0x38",field_info={'fieldname': 'ngif_out_filt_sample', 'length': 2, 'registers': [{'REG': '0x16', 'POS': 6, 'RegisterName': 'NGIF settings 2', 'RegisterLength': 8, 'Name': 'ngif_out_filt_sample[1:0]', 'Mask': '0xC0', 'Length': 2, 'FieldMSB': 1, 'FieldLSB': 0, 'Attribute': 'NN00NNNN', 'Default': '0x0B', 'User': '0000YYYY', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG0'}]},write_value=0x1)
