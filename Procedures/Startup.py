...
def startup():
  ...
  I2C_WRITE(device_address="0x38",field_info={'fieldname': 'digldo_self_ref_ground_pmos', 'length': 1, 'registers': [{'REG': '0x97', 'POS': 7, 'RegisterName': 'VOL_SETTINGS_3', 'RegisterLength': 8, 'Name': 'digldo_self_ref_ground_pmos', 'Mask': '0x80', 'Length': 1, 'FieldMSB': 7, 'FieldLSB': 7, 'Attribute': 'NNNNNNNN', 'Default': '0x02', 'User': '0YYYYYYY', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG0'}]},write_value=0x1)
