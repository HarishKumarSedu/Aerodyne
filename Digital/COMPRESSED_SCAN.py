...
I2C_WRITE(device_address="0x38", field_info={'fieldname': 'scanx_enh', 'length': 1, 'registers': [{'REG': '0x05', 'POS': 0, 'RegisterName': 'SCAN Test', 'RegisterLength': 8, 'Name': 'scanx_enh', 'Mask': '0x1', 'Length': 1, 'FieldMSB': 0, 'FieldLSB': 0, 'Attribute': '000000NN', 'Default': '0x18', 'User': '00000000', 'Clocking': 'SMB', 'Reset': 'A', 'PageName': 'PAG1'}]}, write_value=0x1)
