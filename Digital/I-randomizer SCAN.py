...
Procedure 
    ...
    2.Enable Isense and go to play (to supply the Isense ana block)
    3.Start scan for the I-randomizer
'''
...
I2C_WRITE(device_address="0x38", field_info={'fieldname': 'vis_channel_i_en', 'length': 1, 'registers': [{'REG': '0xA7', 'POS': 1, 'RegisterName': 'Vis enables reg', 'RegisterLength': 8, 'Name': 'vis_channel_i_en', 'Mask': '0x2', 'Length': 1, 'FieldMSB': 1, 'FieldLSB': 1, 'Attribute': '000000NN', 'Default': '0x00', 'User': 'YYYYYYYY', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG0'}]}, write_value=0x1)
...
I2C_WRITE(device_address="0x38", field_info={'fieldname': 'scan_randomizer_i', 'length': 1, 'registers': [{'REG': '0x06', 'POS': 1, 'RegisterName': 'VIS RANDOMIZER SCAN Test', 'RegisterLength': 8, 'Name': 'scan_randomizer_i', 'Mask': '0x2', 'Length': 1, 'FieldMSB': 1, 'FieldLSB': 1, 'Attribute': '000000NN', 'Default': '0x00', 'User': '00000000', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG1'}]}, write_value=0x1)