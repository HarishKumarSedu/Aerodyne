...
# Start of bist
I2C_WRITE(device_address="0x38", field_info={'fieldname': 'bist_en', 'length': 1, 'registers': [{'REG': '0x28', 'POS': 0, 'RegisterName': 'BIST reg', 'RegisterLength': 8, 'Name': 'bist_en', 'Mask': '0x1', 'Length': 1, 'FieldMSB': 0, 'FieldLSB': 0, 'Attribute': '0000RRNN', 'Default': '0x00', 'User': '00000000', 'Clocking': 'REF', 'Reset': 'C', 'PageName': 'PAG1'}]}, write_value=0x1)

sleep (0.00002);

# Read of the result
BIST_RESULT_BIT=I2C_READ(device_address="0x38",field_info={'fieldname': 'bist_result', 'length': 1, 'registers': [{'REG': '0x28', 'POS': 2, 'RegisterName': 'BIST reg', 'RegisterLength': 8, 'Name': 'bist_result', 'Mask': '0x4', 'Length': 1, 'FieldMSB': 2, 'FieldLSB': 2, 'Attribute': '0000RRNN', 'Default': '0x00', 'User': '00000000', 'Clocking': 'REF', 'Reset': 'C', 'PageName': 'PAG1'}]},expected_value=0x0)
BIST_END_BIT=I2C_READ(device_address="0x38",field_info={'fieldname': 'bist_end', 'length': 1, 'registers': [{'REG': '0x28', 'POS': 3, 'RegisterName': 'BIST reg', 'RegisterLength': 8, 'Name': 'bist_end', 'Mask': '0x8', 'Length': 1, 'FieldMSB': 3, 'FieldLSB': 3, 'Attribute': '0000RRNN', 'Default': '0x00', 'User': '00000000', 'Clocking': 'REF', 'Reset': 'C', 'PageName': 'PAG1'}]},expected_value=0x1)
