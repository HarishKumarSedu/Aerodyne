...
Test_Name = 'Self_Reg_LDO_Current'
from Procedures.Startup import startup
from Procedures.Global_enable import global_enable
def self_reg_ldo_current():
  print(f'............ {Test_Name} ........')
  startup()
  global_enable()
  '''
-----------------------------------------------
Turn ON the part in active mode, temp=27°C, vddp=3.7V, vddio=1.8 and the AnaLDO enaled.
Wait 400 us.
Bring out to the analog test point (rfu_ds_ref_test_en_vddd=13d).
Target current is 500nA.
  '''
  # Enabling test page
  ...
  I2C_WRITE(device_address="0x38",field_info={'fieldname': 'test_sel', 'length': 4, 'registers': [{'REG': '0x15', 'POS': 0, 'RegisterName': 'ANA_TESTMUX_SEL', 'RegisterLength': 8, 'Name': 'test_sel[3:0]', 'Mask': '0xF', 'Length': 4, 'FieldMSB': 3, 'FieldLSB': 0, 'Attribute': 'NNNNNNNN', 'Default': '0x00', 'User': '00000000', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG1'}]},write_value=0xD)
  ...
  target_value = 0.5e-6 # 0.5uA
  error_spread = target_value*0.2 # 15% of target value
