...
Wait 400 us.
Bring out to the analog test point (rfu_ds_ref_test_en_vddd=10d).
...
# Bring out to the analog test point (rfu_ds_ref_test_en_vddd=10d) on "IODATA1"
# I2C_WRITE(device_address="0x68",field_info=,write_value=)
target_value = 500e-9 # 500nA
...
print(f"Optimal measured value : {measured_value/ 1e-9}nA, Target vlaue : {target_value/ 1e-9}nA")
