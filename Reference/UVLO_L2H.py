...
---------------------------------------------
  1.UVLO L2H
  2.Turn ON the part in active mode, temp=27°C, vddd=1.2V, UVLO trimmed ({'fieldname': 'otp_ds_ref_pvdd_uvlo_trm', 'length': 5, 'registers': [{'REG': '0xB3', 'POS': 0, 'RegisterName': 'OTP FIELDS 3', 'RegisterLength': 8, 'Name': 'otp_ds_ref_pvdd_uvlo_trm[4:0]', 'Mask': '0x1F', 'Length': 5, 'FieldMSB': 4, 'FieldLSB': 0, 'Attribute': 'NNNNNNNN', 'Default': '60', 'User': '00000000', 'Clocking': 'REF', 'Reset': 'C', 'PageName': 'PAG1'}]}<4:0>=value);
  3.Wait 50 us;
...
while True:
  ...
  force_voltage += 0.005  # increase voltage by 5mV
