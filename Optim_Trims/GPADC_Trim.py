...
def vbat_gpadc_gain_offset_cal(data:{}):
    ...
    VB1_4P8v_pretrim_V = data.get('VB1_4P8v_pretrim_V')
    VB0_2P8v_pretrim_V = data.get('VB0_2P8v_pretrim_V')
    VB1_4P8v_pretrim_code = data.get('VB1_4P8v_pretrim_code')
    VB0_2P8v_pretrim_code = data.get('VB0_2P8v_pretrim_code')
...
def gpadc_vbat_gain_off_trim():
    ...
    pretrim_results = vbat_gpadc_gain_offset_cal({'VB0_2P8v_pretrim_V':VB0_2P8v_pretrim_V,'VB0_2P8v_pretrim_code':VB0_2P8v_pretrim_code,'VB1_4P8v_pretrim_V':VB1_4P8v_pretrim_V,'VB1_4P8v_pretrim_code':VB1_4P8v_pretrim_code})
