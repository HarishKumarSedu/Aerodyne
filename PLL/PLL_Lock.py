...
I2C_WRITE(device_address="0x38", field_info={'fieldname': 'dig_test_en', 'length': 7, 'registers': [{'REG': '0x03', 'POS': 0, 'RegisterName': 'DIGITAL_TEST_SETTINGS_1', 'RegisterLength': 8, 'Name': 'dig_test_en[6:0]', 'Mask': '0x7F', 'Length': 7, 'FieldMSB': 6, 'FieldLSB': 0, 'Attribute': '0NNNNNNN', 'Default': '0x00', 'User': '00000000', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG1'}]}, write_value=hex(18))  #enable "ADDR" and "IODATA1" TMUX
I2C_WRITE(device_address="0x38", field_info={'fieldname': 'dig_test_sel', 'length': 7, 'registers': [{'REG': '0x04', 'POS': 0, 'RegisterName': 'DIGITAL_TEST_SETTINGS_2', 'RegisterLength': 8, 'Name': 'dig_test_sel[6:0]', 'Mask': '0x7F', 'Length': 7, 'FieldMSB': 6, 'FieldLSB': 0, 'Attribute': '0NNNNNNN', 'Default': '0x00', 'User': '00000000', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG1'}]}, write_value=hex(23)) #bring out the pll output on "IODATA1" and pll lock on "ADDR"
...
if (pll_target_value_1 - pll_error_spread_1) < pll_measured_value_1 < (pll_target_value_1 + pll_error_spread_1) and (lock_status > 0.9):
  ...
  print(f'.... {Test_Name}.., Initial Frequency Locking Failed ....')
  print(f'BCLK = {BLCK_Set_1 / 1e6}MHz , pll Freq Measured : {pll_measured_value_1 / 1e6}MHz')