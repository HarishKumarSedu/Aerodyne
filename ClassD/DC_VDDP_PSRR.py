...
sleep(0.0001) 
#Set  VDDP=5V
Vout_5V = VMEASURE(signal="OUTP", reference="OUTN", expected_value = expected_VDDP_5V_value, error_spread = 0)
#set VDDP=2.5V
Vout_2p5V = VMEASURE(signal="OUTP", reference="OUTN",expected_value = expected_VDDP_2p5V_value, error_spread = 0)
