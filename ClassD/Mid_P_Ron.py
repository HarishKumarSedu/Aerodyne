...
def mid_p_ron():
  ...
  I2C_WRITE(device_address="0x38", field_info={'fieldname': 'test_sel', 'length': 4, 'registers': [{'REG': '0x15', 'POS': 0, 'RegisterName': 'ANA_TESTMUX_SEL', 'RegisterLength': 8, 'Name': 'test_sel[3:0]', 'Mask': '0xF', 'Length': 4, 'FieldMSB': 3, 'FieldLSB': 0, 'Attribute': 'NNNNNNNN', 'Default': '0x00', 'User': '00000000', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG1'}]}, write_value=1) # enable kelvon on "IODATA1"
  ...
  dV = VMEASURE(signal="VMID", reference="OUTP", expected_value=0.065, error_spread=0.01)
  MIDP_ron = dV / I_forced  # R = V/I

  print(f'Calculated Mid P-Ron: {MIDP_ron:.3f} Ohms')
