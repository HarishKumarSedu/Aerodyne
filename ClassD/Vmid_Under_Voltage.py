...
def vmid_under_voltage():
  Test_Name = 'Vmid_Under_Voltage'
  print(f'............ {Test_Name} ........')
  startup()
  global_enable()
  playback()
  ...
  I2C_WRITE(device_address="0x38", field_info={'fieldname': 'cld_ocp_ref_mid_ls_sel', 'length': 2, 'registers': [{'REG': '0x9D', 'POS': 6, 'RegisterName': 'CLD analog setting reg 7', 'RegisterLength': 8, 'Name': 'cld_ocp_ref_mid_ls_sel[1:0]', 'Mask': '0xC0', 'Length': 2, 'FieldMSB': 1, 'FieldLSB': 0, 'Attribute': 'NNNNNNNN', 'Default': '0x50', 'User': 'YYYYYYYY', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG0'}]}, write_value=0x0) #lower threshold to 750mV
  ...
  if mid_up > th:
      ...
      for _ in range(max_step):
          ...
          VFORCE(signal="VMID", reference="PGND",value=v_force, error_spread=0.01)   # 500 mA ± 5 %
