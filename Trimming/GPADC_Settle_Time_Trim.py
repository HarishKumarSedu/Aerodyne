...
I2C_WRITE(device_address="0x68",field_info={'fieldname': 'otp_ds_gpadc_del_comp', 'length': 4, 'registers': [{'REG': '0xB4', 'POS': 0, 'RegisterName': 'OTP FIELDS 4', 'RegisterLength': 8, 'Name': 'otp_ds_gpadc_del_comp[3:0]', 'Mask': '0xF', 'Length': 4, 'FieldMSB': 3, 'FieldLSB': 0, 'Attribute': 'NNNNNNNN', 'Default': '04', 'User': '00000000', 'Clocking': 'REF', 'Reset': 'C', 'PageName': 'PAG1'}]},write_value=0xF)
...
# Step size
step_size = 300e3 # assumed 300kHz
...
for i in range(num_steps):
    ...
    measured_value = FREQMEASURE(signal="IOCLK0", reference="GND", expected_value=expected_value, error_spread=error_spread)
