...
def vis_gain_vsns():
  ...
  vsns_gain_high_measured = vsns_gain_high_measured - 0x1000 if vsns_gain_high_measured > 0x1000 else vsns_gain_high_measured
  ...
  vsns_gain_low_measured = vsns_gain_low_measured - 0x1000 if vsns_gain_low_measured > 0x1000 else vsns_gain_low_measured
