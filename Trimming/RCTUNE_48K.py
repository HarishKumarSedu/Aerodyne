...
I2C_READ(device_address="0x38",field_info={'fieldname': 'otp_vis_rc_tun_48', 'length': 4, 'registers': [{'REG': '0xB2', 'POS': 4, 'RegisterName': 'OTP FIELDS 2', 'RegisterLength': 8, 'Name': 'otp_vis_rc_tun_48[3:0]', 'Mask': '0xF0', 'Length': 4, 'FieldMSB': 3, 'FieldLSB': 0, 'Attribute': 'NNNNNNNN', 'Default': '0x84', 'User': '00000000', 'Clocking': 'REF', 'Reset': 'C', 'PageName': 'PAG1'}]},expected_value=0x8)
