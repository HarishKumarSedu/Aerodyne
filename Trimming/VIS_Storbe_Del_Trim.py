...
def vis_storbe_del_trim():
    ...
    I2C_WRITE(device_address="0x38",field_info={'fieldname': 'dig_test_sel', 'length': 7, 'registers': [{'REG': '0x04', 'POS': 0, 'RegisterName': 'DIGITAL_TEST_SETTINGS_2', 'RegisterLength': 8, 'Name': 'dig_test_sel[6:0]', 'Mask': '0x7F', 'Length': 7, 'FieldMSB': 6, 'FieldLSB': 0, 'Attribute': '0NNNNNNN', 'Default': '0x00', 'User': '00000000', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG1'}]},write_value=0xB)
    ...
    sleep(0.001)
    I2C_WRITE(device_address="0x38",field_info={'fieldname': 'vis_sar_strobedly_trim_en', 'length': 1, 'registers': [{'REG': '0x10', 'POS': 0, 'RegisterName': 'FORCING_REG_2', 'RegisterLength': 8, 'Name': 'vis_sar_strobedly_trim_en', 'Mask': '0x1', 'Length': 1, 'FieldMSB': 0, 'FieldLSB': 0, 'Attribute': 'NNNNNNNN', 'Default': '0x00', 'User': '00000000', 'Clocking': 'SMB', 'Reset': 'C', 'PageName': 'PAG1'}]},write_value=0x1)
    ...
    for i in range(num_steps,-1,-1):
        # sweep trimg code
        I2C_WRITE(device_address="0x38",field_info={'fieldname': 'otp_ds_vis_sar_strobedly_trim', 'length': 4, 'registers': [{'REG': '0xB2', 'POS': 0, 'RegisterName': 'OTP FIELDS 2', 'RegisterLength': 8, 'Name': 'otp_ds_vis_sar_strobedly_trim[3:0]', 'Mask': '0xF', 'Length': 4, 'FieldMSB': 3, 'FieldLSB': 0, 'Attribute': 'NNNNNNNN', 'Default': '0x84', 'User': '00000000', 'Clocking': 'REF', 'Reset': 'C', 'PageName': 'PAG1'}]},write_value=hex(i))
    ...
    if lower_limit < optimal_measured_value < higher_limit:
        ...
        I2C_WRITE(device_address="0x38",field_info={'fieldname': 'otp_ds_vis_sar_strobedly_trim', 'length': 4, 'registers': [{'REG': '0xB2', 'POS': 0, 'RegisterName': 'OTP FIELDS 2', 'RegisterLength': 8, 'Name': 'otp_ds_vis_sar_strobedly_trim[3:0]', 'Mask': '0xF', 'Length': 4, 'FieldMSB': 3, 'FieldLSB': 0, 'Attribute': 'NNNNNNNN', 'Default': '0x84', 'User': '00000000', 'Clocking': 'REF', 'Reset': 'C', 'PageName': 'PAG1'}]},write_value=optimal_code)
    else:
        print(f'............ {Test_Name} Failed ........')
        # if the trimh failed program detult zero
        I2C_WRITE(device_address="0x38",field_info={'fieldname': 'otp_ds_vis_sar_strobedly_trim', 'length': 4, 'registers': [{'REG': '0xB2', 'POS': 0, 'RegisterName': 'OTP FIELDS 2', 'RegisterLength': 8, 'Name': 'otp_ds_vis_sar_strobedly_trim[3:0]', 'Mask': '0xF', 'Length': 4, 'FieldMSB': 3, 'FieldLSB': 0, 'Attribute': 'NNNNNNNN', 'Default': '0x84', 'User': '00000000', 'Clocking': 'REF', 'Reset': 'C', 'PageName': 'PAG1'}]},write_value=0x0)
