...
def fll_freerun():
    ...
    if lower_limit < optimal_measured_value < higher_limit:
        ...
        I2C_WRITE(device_address="0x38",field_info={'fieldname': 'otp_ds_fll_vco_trm_5l', 'length': 6, 'registers': [{'REG': '0xB7', 'POS': 0, 'RegisterName': 'OTP FIELDS 7', 'RegisterLength': 8, 'Name': 'otp_ds_fll_vco_trm_5l[5:0]', 'Mask': '0x3F', 'Length': 6, 'FieldMSB': 5, 'FieldLSB': 0, 'Attribute': 'NNNNNNNN', 'Default': '0x22', 'User': '00000000', 'Clocking': 'REF', 'Reset': 'C', 'PageName': 'PAG1'}]},write_value=optimal_code)
    else:
