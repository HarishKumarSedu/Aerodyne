...
AFORCE(signal="OUTP",reference="GND",value=float('Inf'), error_spread=source_current*0.01) # 1% error
AFORCE(signal="OUTN",reference="GND",value=-float('Inf'), error_spread=source_current*0.01) # 1% error