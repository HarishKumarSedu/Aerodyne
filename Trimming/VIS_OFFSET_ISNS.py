...
def vis_offset_isns():
  ...
  vsns_offset_measured= (0x10000 - isns_offset_measured) >> 8 &0x3F  if isns_offset_measured & 0x8000 else 0x40 - (isns_offset_measured >> 8)&0x3f
  
  print(f'{Testname} value : {hex(vsns_offset_measured)} ')
  I2C_WRITE("0x38", field_info={'fieldname': 'otp_isense_offset', 'length': 6, 'registers': [{'REG': '0xBA', 'POS': 0, 'RegisterName': 'OTP FIELDS 10', 'RegisterLength': 8, 'Name': 'otp_isense_offset[5:0]', 'Mask': '0x3F', 'Length': 6, 'FieldMSB': 5, 'FieldLSB': 0, 'Attribute': 'NNNNNNNN', 'Default': '0x00', 'User': '00000000', 'Clocking': 'REF', 'Reset': 'C', 'PageName': 'PAG1'}]}, write_value=hex(isns_offset_measured))
